...
#[Route('/carnet-educatif')]  // ← Add a common prefix to avoid conflicts with other controllers
final class CarnetEducatifController extends AbstractController
{
    // 1. Static routes FIRST (no {id} wildcards)
    ...
    // 2. /new before /{id} — otherwise "new" gets captured as an id
    ...
    // 3. /{id}/sub-routes BEFORE plain /{id}
    ...
    #[Route('/{id}/delete', name: 'app_carnet_educatif_delete', methods: ['POST'])]
