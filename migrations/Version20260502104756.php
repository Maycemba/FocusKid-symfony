 ...
 */
final class Version20260502104756 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE question_exercice ADD CONSTRAINT FK_87107741B4C32BD8 FOREIGN KEY (id_exercice) REFERENCES exercices (id_exercice)');
        ...
        $this->addSql('ALTER TABLE reponse_user_exercice ADD CONSTRAINT FK_2F511A80B4C32BD8 FOREIGN KEY (id_exercice) REFERENCES exercices (id_exercice)');
